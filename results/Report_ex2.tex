...
We use a rank-based ACO variant, i.e., we update with the pheromone matrix with the $w-1$ iteration-best ants ($w$ = 5 for 10 ants in our
...
and stop the algorithm after either 20 minutes or after 25 iterations without increase of satisfaction. 
...
optimal results. The tour-opt incurred a large part of the runtime.
...
\begin{table}
  ...
  \begin{tabular}{lrrrrrr}
   \multirow{2}{*}{\bfseries Problem} &
      \multicolumn{4}{c}{\bfseries -a 6 -H 1 -I -P 0.2 -conf } \\
    &
    \bfseries Max. Satis. &
    \bfseries Avg Satis. &
    \bfseries Std. dev. &
...
\begin{table}
  ...
  \begin{tabular}{lrrrrrr}
   \multirow{2}{*}{\bfseries Problem} &
      \multicolumn{4}{c}{\bfseries -a 8 -H 1 -I -P 0.2 -conf } \\
    &
    \bfseries Max. Satis. &
    \bfseries Avg Satis. &
    \bfseries Std. dev. &
...
\begin{table}
  ...
  \begin{tabular}{lrrrrrr}
   \multirow{2}{*}{\bfseries Problem} &
      \multicolumn{4}{c}{\bfseries -a 6 -H 1 -I -W 1 -U 5 -D -1 -conf } \\
    &
    \bfseries Max. Satis. &
    \bfseries Avg Satis. &
    \bfseries Std. dev. &
...
\begin{table}
  ...
  \begin{tabular}{lrrrrrr}
   \multirow{2}{*}{\bfseries Problem} &
      \multicolumn{4}{c}{\bfseries -a 8 -H 1 -I -W 1 -U 5 -D -1 -conf } \\
    &
    \bfseries Max. Satis. &
    \bfseries Avg Satis. &
    \bfseries Std. dev. &
...
\begin{table}
  ...
  \begin{tabular}{lrrrrrr}
   \multirow{2}{*}{\bfseries Problem} &
      \multicolumn{4}{c}{\bfseries -a 6 -H 1 -I -W 1 -U 5 -D -1 -P 0.2 -conf14 } \\
    &
    \bfseries Max. Satis. &
    \bfseries Avg Satis. &
    \bfseries Std. dev. &
...
\begin{table}
  ...
  \begin{tabular}{lrrrrrr}
   \multirow{2}{*}{\bfseries Problem} &
      \multicolumn{4}{c}{\bfseries -a 8 -H 1 -I -W 1 -U 5 -D -1 -P 0.2 -conf14 } \\
    &
    \bfseries Max. Satis. &
    \bfseries Avg Satis. &
    \bfseries Std. dev. &
...
\begin{figure}
\centering
\includegraphics{graphs/ACONEXT.pdf}
...
\begin{figure}
\centering
\includegraphics{graphs/ACO.pdf}
...
\begin{figure}
\centering
\includegraphics{graphs/ACOVND.pdf}
