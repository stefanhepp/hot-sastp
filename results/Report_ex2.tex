...
% TODO some description of setups used
...
In the evaluation we always update the pheromone matrix with the optimized solutions. This allows the ants to find much better (though not
